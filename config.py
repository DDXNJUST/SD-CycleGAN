...
def configuration():
    ...
    # Training arguments       
    parser.add_argument('--gpu', type=str, default='0', help="Numbers of GPU that will be used")
    
    # Model arguments
    parser.add_argument('--batch_size', type=int, default=2, help="Batch size")
    parser.add_argument('--channel', type=int, default=5, help="Number of channels of input image")
    parser.add_argument('--n_feature', type=int, default=32, help="Number of feature maps")
    parser.add_argument('--factor', type=int, default=2, help="Rate for feature map increase")
    parser.add_argument('--D_kernel_size', type=int, default=3, help='Number of kernel size for discriminator')
    ...
    parser.add_argument('--eta', type=float, default=0.1, help="Regularization hyperparameter for gradient penalty")
    parser.add_argument('--gamma', type=float, default=5, help="Hyperparameter for cyclic loss")  # 5
